...
if("TRUE" STREQUAL "TRUE")
  set(test_osm_SOURCE_PREFIX /home/khoa/catkin_ws/src/open_street_map/test_osm)
  set(test_osm_DEVEL_PREFIX /home/khoa/catkin_ws/devel_isolated/test_osm)
  set(test_osm_INSTALL_PREFIX "")
  set(test_osm_PREFIX ${test_osm_DEVEL_PREFIX})
else()
  set(test_osm_SOURCE_PREFIX "")
  set(test_osm_DEVEL_PREFIX "")
  set(test_osm_INSTALL_PREFIX /home/khoa/catkin_ws/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_osm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/khoa/catkin_ws/src/open_street_map/test_osm/${idir}'.  ${_report}")
    endif()
