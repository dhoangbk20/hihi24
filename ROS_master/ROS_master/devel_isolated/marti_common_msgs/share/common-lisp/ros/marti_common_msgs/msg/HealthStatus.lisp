...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HealthStatus>)))
  ...
  (cl:format cl:nil "# This message is intended for use as a light-weight machine status indicator for robot consumption~%# whereas Diagnostics are for human consumption~%~%int8 OK=0    # Initialized with no issues~%int8 WARN=1  # Component is operating but the data may be inaccurate or there may be minor problems~%int8 ERROR=2 # Component has encountered a serious problem and cannot or will not operate~%int8 STALE=3 # Uninitialized or cannot determine status~%~%std_msgs/Header header~%~%int8   status~%string message~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HealthStatus)))
  "Returns full string definition for message of type 'HealthStatus"
  (cl:format cl:nil "# This message is intended for use as a light-weight machine status indicator for robot consumption~%# whereas Diagnostics are for human consumption~%~%int8 OK=0    # Initialized with no issues~%int8 WARN=1  # Component is operating but the data may be inaccurate or there may be minor problems~%int8 ERROR=2 # Component has encountered a serious problem and cannot or will not operate~%int8 STALE=3 # Uninitialized or cannot determine status~%~%std_msgs/Header header~%~%int8   status~%string message~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
