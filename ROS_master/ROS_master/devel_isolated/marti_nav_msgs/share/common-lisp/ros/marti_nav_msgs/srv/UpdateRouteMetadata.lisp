...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UpdateRouteMetadata-request>)))
  ...
  (cl:format cl:nil "# This service is intended for modifying the properties on an existing route ~%# and its points.~%# ~%# The use of this service is a little non-intuitive.  Set route_guid to the GUID~%# of the route you want to modify, and fill metadata_points with all of the points~%# you want to modify.  The coordinates of the points actually don't matter; the~%# \"guid\" property will be matched against an existing point in the route, and that~%# point's properties will be replaced with the one in the new point.~%string route_guid # The GUID of the route to modify~%marti_nav_msgs/RoutePoint[] metadata_points # All of the points that should be modified~%~%================================================================================~%MSG: marti_nav_msgs/RoutePoint~%geometry_msgs/Pose           pose~%string                       id         # unique identifier for this point~%marti_common_msgs/KeyValue[] properties~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: marti_common_msgs/KeyValue~%# An arbitrary key-value pair~%~%string key~%string value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UpdateRouteMetadata-request)))
  "Returns full string definition for message of type 'UpdateRouteMetadata-request"
  (cl:format cl:nil "# This service is intended for modifying the properties on an existing route ~%# and its points.~%# ~%# The use of this service is a little non-intuitive.  Set route_guid to the GUID~%# of the route you want to modify, and fill metadata_points with all of the points~%# you want to modify.  The coordinates of the points actually don't matter; the~%# \"guid\" property will be matched against an existing point in the route, and that~%# point's properties will be replaced with the one in the new point.~%string route_guid # The GUID of the route to modify~%marti_nav_msgs/RoutePoint[] metadata_points # All of the points that should be modified~%~%================================================================================~%MSG: marti_nav_msgs/RoutePoint~%geometry_msgs/Pose           pose~%string                       id         # unique identifier for this point~%marti_common_msgs/KeyValue[] properties~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: marti_common_msgs/KeyValue~%# An arbitrary key-value pair~%~%string key~%string value~%~%~%"))
