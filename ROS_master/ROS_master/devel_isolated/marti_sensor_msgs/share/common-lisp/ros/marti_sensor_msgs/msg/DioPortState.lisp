...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DioPortState>)))
  ...
  (cl:format cl:nil "# Message containing the value of a digital i/o port.  This is used by~%# the rtd_dm7820 driver to send digital input changes and accept~%# digital output commands.~%~%std_msgs/Header header~%# header contains the time that the event occurred.~%~%uint64 value~%# The new state of the port.  The meaning of the value depends on how~%# the port is configured.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DioPortState)))
  "Returns full string definition for message of type 'DioPortState"
  (cl:format cl:nil "# Message containing the value of a digital i/o port.  This is used by~%# the rtd_dm7820 driver to send digital input changes and accept~%# digital output commands.~%~%std_msgs/Header header~%# header contains the time that the event occurred.~%~%uint64 value~%# The new state of the port.  The meaning of the value depends on how~%# the port is configured.~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
