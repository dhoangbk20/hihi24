...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/khoa/catkin_ws/src/rosbridge_suite-master/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/khoa/catkin_ws/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/khoa/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/khoa/catkin_ws/src/rosbridge_suite-master/rosbridge_server/${idir}'.  ${_report}")
    endif()
