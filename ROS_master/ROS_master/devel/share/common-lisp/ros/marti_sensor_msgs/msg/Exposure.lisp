...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Exposure>)))
  ...
  (cl:format cl:nil "# This message contains an an exposure value along with a~%# message header.  This message is to keep the same format~%# that we have with Image and CameraInfo.~%~%std_msgs/Header header           # Header timestamp is the time when all ~%                                 # images were acquired and synchronized.~%                                 # Header frame_id is the count of these~%                                 # messages sent since the start.~%                               ~%uint64 value                     # Exposure value~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Exposure)))
  "Returns full string definition for message of type 'Exposure"
  (cl:format cl:nil "# This message contains an an exposure value along with a~%# message header.  This message is to keep the same format~%# that we have with Image and CameraInfo.~%~%std_msgs/Header header           # Header timestamp is the time when all ~%                                 # images were acquired and synchronized.~%                                 # Header frame_id is the count of these~%                                 # messages sent since the start.~%                               ~%uint64 value                     # Exposure value~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
