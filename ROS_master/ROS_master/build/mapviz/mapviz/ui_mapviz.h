...
public:
    ...
    void setupUi(QMainWindow *mapviz)
    {
        ...
        actionSaveAs_config->setObjectName(QStringLiteral("actionSaveAs_config"));
    ...
    void retranslateUi(QMainWindow *mapviz)
    {
        ...
        actionSaveAs_config->setText(QApplication::translate("mapviz", "Save Config As...", Q_NULLPTR));
